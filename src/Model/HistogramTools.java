...
public class HistogramTools {
    ...
    public static void plotHistogram(double [] histogram, String titre) throws IOException{
        ...
        JFreeChart jfreechart = ChartFactory.createXYBarChart(("Histogramme de l'image" + titre), "Niveaux de gris", false, "Nombre de pixels", myseriescollection, PlotOrientation.VERTICAL, true, false, false);
